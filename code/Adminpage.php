                        ...
                        (function(n) {
                            $.ajax({
                                ...
                                success: function(datas) {
                                    ...
                                    var strconc = `<div style="margin-right: 10px; cursor: pointer; padding: 5px;">
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(datame) {
                                            ...
                                            for (var i = 0; i < filteredEventData.length; i++) {
                                                ...
                                                var rstrconc = `<div style="margin-top: 20px; display: flex; flex-direction: row; justify-content: space-between;">
                                                        <div style="display: flex; flex-direction: row;">
